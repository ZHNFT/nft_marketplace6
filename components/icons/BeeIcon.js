...
export default function BeeIcon({ className }) {
    return ( 
        ...
        <stop offset="0.6" stopColor="#FFCD50" stopOpacity="0.32"/>
        <stop offset="0.77" stopColor="#FFCD50" stopOpacity="0.41"/>
        ...
        <stop offset="0.39" stopColor="#FFD95D" stopOpacity="0.89"/>
        <stop offset="0.56" stopColor="#FFD752" stopOpacity="0.95"/>
