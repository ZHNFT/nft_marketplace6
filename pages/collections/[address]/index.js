      ...
      <section className={clsx(
        ...
        <>
          <Sidebar className={clsx(
            ...
            'fixed z-10 sm:relative top-0 sm:top-auto bottom-0 left-0 sm:left-auto mobile-only:bg-[#1f2225] mobile-only:px-10 mobile-only:overflow-y-auto mobile-only:overflow-x-hidden',
